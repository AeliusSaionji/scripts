...
if ( -NOT ([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole] "Administrator") ) {
	...
	#	Invoke-WebRequest -UseBasicParsing "http://www.foobar2000.org/getfile/5ade2dfcc3b9483f33cfff60cf8189e7/foobar2000_v1.3.8.exe" -OutFile "$ENV:TEMP\foobar2000_v1.3.8.exe"
		...
		Invoke-WebRequest -UseBasicParsing "http://6d249e2930674d9a0246-22b39505feb4cbdca036d208d587baec.r76.cf1.rackcdn.com/RevoUninProSetup.exe" -OutFile "$ENV:TEMP\RevoUninProSetup.exe"
